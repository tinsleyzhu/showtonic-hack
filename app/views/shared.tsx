...
import { collapseFestivalShows } from "../discover.js";
...
// One card per festival lives in app/discover.js (pure, unit-tested); the
// shared surface re-exports it so every view keeps the same import path.
export { collapseFestivalShows };

// One date line for a card: a festival card spans its run; a show shows its date.
export function formatShowDate(show: Show) {
  const range = show.dateRange;
