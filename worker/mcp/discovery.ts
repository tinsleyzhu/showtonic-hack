  ...
  return {
    ...
    authentication: {
      ...
      scopes: [
        ...
        { id: "write:candidates", description: "Reconstruct nights from photo metadata and propose them. Proposing only — resolution is a separate grant." },
        { id: "resolve:candidates", description: "Accept or reject proposed nights. Separate from write:candidates so an agent cannot approve its own proposals. Never granted by default." },
